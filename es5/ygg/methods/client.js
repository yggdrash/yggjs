...
var methods = function methods() {
    ...
    return [getBalance, getBranchId, getBlock, getTransaction, getTransactionFromBlock, getTransactionReceipt, signTransaction, transfer, sendTransaction, sign, branch, plant, unregister];
};
