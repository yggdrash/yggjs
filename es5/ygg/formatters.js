...
var inputBigNumberFormatter = function inputBigNumberFormatter(number) {
    return number;
};
...
var inputStringFormatter = function inputStringFormatter(str) {
    return str;
};
...
var inputSeedFormatter = function inputSeedFormatter(seed) {
...
var inputBranchRegisterFormatter = function inputBranchRegisterFormatter(params) {
    // TODO: data exception handling

    return params;
};

var inputBranchIdFormatter = function inputBranchIdFormatter(branchId) {
    return branchId;
};
