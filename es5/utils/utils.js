...
var yggUtils = require('yggjs-utils');
...
var hexString = function hexString(str) {
...
var dataToJson = function dataToJson(data) {
    data.toJSON = function (key) {
        var replacement = new Object();
        for (var val in this) {
            if (typeof this[val] === 'string') replacement[val] = this[val].toUpperCase();else replacement[val] = this[val];
        }
        return replacement;
    };
...
var dataToJsonNonArray = function dataToJsonNonArray(data) {
    data.toJSON = function (key) {
        var replacement = new Object();
        for (var val in this) {
            if (typeof this[val] === 'string') replacement[val] = this[val].toUpperCase();else replacement[val] = this[val];
...
var branchId = function branchId(name, property, type, timestamp, version, reference_address, reserve_address) {

    var nameBuf = Buffer.from(name);
    var propertyBuf = Buffer.from(property);
    var typeBuf = Buffer.from(type);
    var timestampBuf = Buffer.from(timestamp.toString());
    var versionBuf = Buffer.from(version);
    var referenceAddressBuf = Buffer.from(reference_address);
    var reserveAddressBuf = Buffer.from(reserve_address);

    var branchIdHex = nameBuf.toString() + propertyBuf.toString() + typeBuf.toString() + timestampBuf.toString() + versionBuf.toString() + referenceAddressBuf.toString() + reserveAddressBuf.toString();

    var branchIdByte = Buffer.from(branchIdHex);
    var branchId = yggUtils.sha3(branchIdByte);

    return branchId.toString("hex").substring(24, 64);
};

var bodyHashHex = function bodyHashHex(jsonBody) {
    return yggUtils.sha3(Buffer.from(jsonBody)).toString("hex");
};
...
module.exports = (_module$exports = {
    ...
    isJson: isJson,
    isTopic: isTopic
}, _defineProperty(_module$exports, 'toHex', toHex), _defineProperty(_module$exports, 'hexToBytes', hexToBytes), _defineProperty(_module$exports, 'bytesToHex', bytesToHex), _defineProperty(_module$exports, 'hexToNumber', hexToNumber), _defineProperty(_module$exports, 'decimalToHex', decimalToHex), _defineProperty(_module$exports, 'hexToNumberString', hexToNumberString), _defineProperty(_module$exports, 'numberToHex', numberToHex), _defineProperty(_module$exports, 'dataToJson', dataToJson), _defineProperty(_module$exports, 'dataToJsonNonArray', dataToJsonNonArray), _defineProperty(_module$exports, 'toBuffer', toBuffer), _defineProperty(_module$exports, 'branchId', branchId), _defineProperty(_module$exports, 'bodyHashHex', bodyHashHex), _defineProperty(_module$exports, 'hexString', hexString), _module$exports);