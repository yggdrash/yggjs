...
var methods = function () {
    ...
    let getTransactionByHash = new Method({
    ...
    let transferFromBody = new Method({
        ...
        call: 'transferFrom',
        params: 4,
        inputFormatter: [formatters.inputAddressFormatter, formatters.inputAddressFormatter, formatters.inputAddressFormatter, formatters.inputBigNumberFormatter]
    });
    ...
    let getAllActivePeer = new Method({
        name: 'getAllActivePeer',
        call: 'getAllActivePeer',
    });
