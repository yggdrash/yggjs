...
RequestManager.prototype.send = function (data) {
    ...
    switch(payload.method) {
        ...
        case 'ygg_sendTransaction':
            let sendTransactionResult = Jsonrpc.sendTX(data.method, data.params, this.provider.host);
        ...
        case 'ygg_register':
            let registerResult = Jsonrpc.sendTX(data.method, data.params, this.provider.host);
