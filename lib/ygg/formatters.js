...
const inputQueryFormatter =  (options) => {
    return options;
};
...
const inputTransactionHashFormatter = txhash => {
    if (utils.isTopic(txhash)) {
        return txhash
    }
...
module.exports = {
    ...
    inputTransactionHashFormatter: inputTransactionHashFormatter,
