...
var keccak512 = require('js-sha3').keccak_512
var keccak384 = require('js-sha3').keccak_384
var keccak256 = require('js-sha3').keccak_256
var keccak224 = require('js-sha3').keccak_224
...
var MerkleTools = function (treeOptions) {
  ...
  var hashFunction = function (value) {
    switch (hashType) {
      ...
      case 'KECCAK-512':
        return Buffer.from(keccak512.array(value))
      case 'KECCAK-384':
        return Buffer.from(keccak384.array(value))
      case 'KECCAK-256':
        return Buffer.from(keccak256.array(value))
      case 'KECCAK-224':
        return Buffer.from(keccak224.array(value))
      default:
