...
Wallet.generate = function (icapDirect) {
  if (icapDirect) {
    let max = new yggUtil.BN('088f924eeceeda7fe92e1f5b0fffffffffffffff', 16)
    while (true) {
...
Wallet.prototype.toKeystore = function (password, opts) {
  ...
  let cipher = crypto.createCipheriv(opts.cipher || 'aes-128-cbc', derivedKey.slice(0, 16), iv)

  // let cipher = crypto.createCipheriv(opts.cipher || 'aes-256-ctc', derivedKey, iv)
